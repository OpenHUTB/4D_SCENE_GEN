...
# 执行训练：
# --do_train --model_name D:\gpt921\webui\models\WizardCoder-15B-V1.0 --train_file D:\gpt921\webui\data\scenario_generation_final.json --valid_file D:\gpt921\webui\data\scenario_generation_final.json
# 一秒钟更新一次GPU信息：nvidia-smi -l 1

# 不支持执行量化模型（TheBloke/WizardCoder-15B-1.0-GPTQ）的预测

# 执行推断：
# --do_predict --model_name D:\gpt921\webui\models\WizardCoder-15B-V1.0 --prompt  创建一个驾驶场景对象scenario，并在场景中创建了一个车辆对象v1。  --output_dir D:\gpt921\webui\outputs-finetuned-wizardcoder
...
if __name__ == '__main__':
    ...
    parser.add_argument("--num_epochs", type=int, default=500, help="Num of training epochs")
